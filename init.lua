...
vim.api.nvim_set_keymap("n", "<leader>mg", ':lua require("nvim-code-eval-plugin").eval_code_all_un_commited_git_files() <CR>', { desc = "Eval files uncommited files" })
vim.api.nvim_set_keymap("n", "<leader>mG", ':lua require("nvim-code-eval-plugin").eval_code_all_un_commited_git_files("all") <CR>', { desc = "Eval on all servers files uncommited files" })
vim.api.nvim_set_keymap("n", "<leader>mh", ':lua require("nvim-code-eval-plugin").eval_code_all_git_files_from_commit_hash() <CR>', { desc = "Eval by hash commit"})
vim.api.nvim_set_keymap("n", "<leader>mH", ':lua require("nvim-code-eval-plugin").eval_code_all_git_files_from_commit_hash("all") <CR>', { desc = "Eval on all servers by hash commit"})
vim.api.nvim_set_keymap("n", "<leader>mn", ':lua require("nvim-code-eval-plugin").copy_notice() <CR>', { desc = "Copy notice"})
vim.api.nvim_set_keymap("n", "<leader>mN", ':lua require("nvim-code-eval-plugin").copy_notice_from_commit() <CR>', { desc = "Copy notice from hash commit"})
